      ...
      <div style={{ maxWidth: '720px', margin: '64px auto', padding: '0 24px 96px' }}>
        ...
        {[
          ...
          },
          {
            ...
            body: 'If your item arrived damaged, defective, or incorrect, please contact us within 7 days of delivery at contactbylvra@gmail.com with:\n— Your order number\n— A photo of the damaged item and packaging\n\nWe will arrange a replacement or full refund at no cost to you, including return shipping.'
          },
          {
            icon: <Clock size={20}/>,
        ...
        <div style={{ background: '#1A1A1A', borderRadius: '12px', padding: '32px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#aaa', marginBottom: '24px', fontSize: '14px' }}>Email us at contactbylvra@gmail.com and we'll have you sorted within 24 hours.</p>

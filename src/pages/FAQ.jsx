...
const FAQS = [
  ...
  { q: 'Are your products safe for sensitive skin?', a: 'Most Lumara products are formulated without fragrance, essential oils, and common sensitisers. Each product page lists all ingredients clearly. If you have specific skin concerns or allergies, we recommend patch-testing for 24 hours before full use.' },
  ...
  { q: 'Can I change or cancel my order?', a: 'Orders can be modified or cancelled within 2 hours of placement. After that, orders enter our processing queue and cannot be changed. Contact hello@lumara.com immediately with your order number if you need to make changes.' },
  ...
  { q: 'Are Lumara products cruelty-free?', a: 'Yes. All Lumara products are cruelty-free — we do not conduct or commission animal testing at any stage of development. Our devices and skincare formulas are tested on human volunteers only.' },
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: '#fff' }}>
      <div style={{ background: '#FAFAFA', padding: '72px 24px', textAlign: 'center', borderBottom: '1px solid #F0F0F0' }}>
        ...
        <p style={{ fontSize: '16px', color: '#666', maxWidth: '480px', margin: '0 auto' }}>Everything you need to know about Lumara, our products, and your orders.</p>
      </div>

      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '64px 24px 0' }}>
        ...
        <div style={{ maxWidth: '720px' }}>
          {[
            ...
            { title: 'Lost or Damaged Packages', body: 'If your package arrives damaged or does not arrive within the estimated delivery window, please contact us at hello@lumara.com with your order number. We will investigate with the carrier and either reship your order or issue a full refund at our discretion. Claims for lost packages must be submitted within 30 days of the estimated delivery date.' },
            { title: 'Address Changes', body: 'Address changes can only be accommodated within 2 hours of placing your order, before it enters our processing queue. Contact hello@lumara.com immediately with your order number and updated address. Once an order is dispatched, we cannot redirect shipments.' },
          ].map((s, i) => (
